...
import 'package:flutter_app/SampleTMDBConfig.dart';
...
class BottomNavigationWidgetState extends State<BottomNavigationWidget> {
  ...
  final _bottomTextColor = Colors.grey;
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
              icon: Icon(Icons.event_seat, color: _bottomNavigationColor,),
              title: Text("Now Playing",
                style: TextStyle(color: _bottomTextColor),)),
          BottomNavigationBarItem(
              icon: Icon(Icons.event, color: _bottomNavigationColor,),
              title: Text(
                "Upcoming", style: TextStyle(color: _bottomTextColor),)),
          BottomNavigationBarItem(
              icon: Icon(Icons.favorite, color: _bottomNavigationColor,),
              title: Text(
                "Popular", style: TextStyle(color: _bottomTextColor),)),
        ],
...
List<Widget> createNowPlayingMovieCardItem(List<NowPlayingMovie> movies,
...
List<Widget> createUpcomingMovieCardItem(List<UpcomingMovie> movies,
    BuildContext context) {
  // Children list for the list.
  List<Widget> listElementWidgetList = new List<Widget>();
  if (movies != null) {
...
List<Widget> createPopularMovieCardItem(List<PopularMovie> movies,
    BuildContext context) {
  // Children list for the list.
  List<Widget> listElementWidgetList = new List<Widget>();
  if (movies != null) {
